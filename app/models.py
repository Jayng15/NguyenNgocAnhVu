...
class User(Base):
    ...
    received_messages: Mapped[list["MessageRecipient"]] = relationship(
        "MessageRecipient", back_populates="recipient", cascade="all, delete-orphan"
    )
...
class Message(Base):
    ...
    recipients: Mapped[list["MessageRecipient"]] = relationship("MessageRecipient", back_populates="message", cascade="all, delete-orphan")
